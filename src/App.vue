      ...
      <div class="dropdown ml-auto">
        ...
        >
          ...
          <table class="table table-sm">
            ...
            <div v-else class="text-center text-danger mt-3">您當前的購物車為空</div>
          </table>
...
export default {
  ...
  methods: {
    getCart() {
      this.$store.dispatch("CModule/getCart");
    },
    removeCart(id) {
      this.$store.dispatch("CModule/removeCart", id);
    },
  },
  created() {
    this.getCart();
  ...
  computed: {
    ...
    cart() {
      return this.$store.state.CModule.cart;
    },
  },
};
</script>
